...
import { saveToDB, loadFromDB, saveWeightToDB, loadWeightsFromDB, saveSessionToDB, loadSessionsFromDB,
    } from './services/db';
    ...
    return (
        <div className="App">
            ...
            >
                ...
                <StatsModal isOpen={isStatsOpen} onClose={() => setIsStatsOpen(false)} weights={weights} records={records}
                            knownExercises={knownExercises} t={t} />
                <CalendarModal
